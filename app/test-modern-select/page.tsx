    ...
    <div className="min-h-screen bg-[#0f0f0f] text-white p-8">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div>
          ...
          <p className="text-text-secondary">Testing all features: single/multi-select, search, groups, keyboard nav</p>
        </div>
        ...
        <section>
          ...
          <div className="bg-background-primary rounded-lg p-4 mt-4 max-w-4xl">
            <p className="text-sm text-text-secondary">Selected value:</p>
        ...
        <section>
          ...
          <div className="bg-background-primary rounded-lg p-4 mt-4 max-w-2xl">
            <p className="text-sm text-text-secondary">Selected values:</p>
        ...
        <section>
          ...
          <div className="bg-background-primary rounded-lg p-4 mt-4 max-w-2xl text-sm">
