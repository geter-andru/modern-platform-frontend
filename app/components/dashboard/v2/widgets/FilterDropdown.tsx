...
/**
 * FilterDropdown - Professional dropdown filter component
 *
 * Features:
...
export type FilterIconType = 'calendar' | 'target' | 'activity' | 'filter';

export interface FilterOption {
  /** Option value (used for onChange) */
  value: string;
  /** Display label */
  label: string;
...
const FILTER_ICONS: Record<FilterIconType, LucideIcon> = {
  calendar: Calendar,
  target: Target,
  activity: Activity,
  filter: Filter
