...
/**
 * ModernInput - Advanced input component system for Next.js App Router
 *
 * Features:
 * - Multiple input types (text, password, email, search, etc.)
 * - Different sizes (sm, md, lg)
 * - Multiple variants (default, filled, underlined, borderless)
...
const ModernInput = forwardRef<HTMLInputElement, InputProps>(({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case 'filled':
        return 'bg-gray-800 border border-transparent hover:border-gray-600 focus-within:border-purple-500';
      case 'underlined':
        return 'bg-transparent border-0 border-b-2 border-gray-700 rounded-none hover:border-gray-600 focus-within:border-purple-500';
      case 'borderless':
        return 'bg-transparent border-0 hover:bg-gray-800/50 focus-within:bg-gray-800/50';
      default:
        return 'bg-gray-800 border border-gray-700 hover:border-gray-600 focus-within:border-purple-500';
    }
  };
        ...
        {shouldShowFloatingLabel && (
          <motion.label
            ...
            className={`
              ...
              ${!isEmpty || isFocused ? 'text-purple-400' : ''}
            `}
          >
            {label}
          </motion.label>
...
export const ModernTextarea = forwardRef<HTMLTextAreaElement, TextareaProps>(({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case 'filled':
        return 'bg-gray-800 border border-transparent hover:border-gray-600 focus:border-purple-500';
      case 'underlined':
        return 'bg-transparent border-0 border-b-2 border-gray-700 rounded-none hover:border-gray-600 focus:border-purple-500';
      case 'borderless':
        return 'bg-transparent border-0 hover:bg-gray-800/50 focus:bg-gray-800/50';
      default:
        return 'bg-gray-800 border border-gray-700 hover:border-gray-600 focus:border-purple-500';
    }
  };
