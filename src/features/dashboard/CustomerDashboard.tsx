...
// ProgressNotifications and useProgressNotifications are defined in ActiveToolDisplay.tsx
// We'll import them from there or define them locally
import WelcomeHero from '../../shared/components/progressive-engagement/WelcomeHero'
...
const CustomerDashboard: React.FC = () => {
  ...
  return (
    <DashboardAccessControl {...(workflowData as any)}>
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="fixed top-4 right-4 z-50">
          <button
            onClick={() => setDashboardLayout(prev => prev === 'integrated' ? 'progressive' : 'integrated')}
