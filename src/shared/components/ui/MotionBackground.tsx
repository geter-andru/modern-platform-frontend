 ...
 * - Lazy loaded framer-motion for better initial page load
 */

// Lazy load animated orb component (which imports framer-motion)
const AnimatedOrb = lazy(() => import('./AnimatedOrb'));
  ...
  return (
    <Suspense fallback={<StaticBackground />}>
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        {/* Animated gradient orbs - lazy loaded */}
        <AnimatedOrb
          className="absolute top-0 -left-1/4 w-1/2 h-1/2 rounded-full"
          style={{
            background: 'radial-gradient(circle, rgba(59, 130, 246, 0.35) 0%, transparent 70%)',
