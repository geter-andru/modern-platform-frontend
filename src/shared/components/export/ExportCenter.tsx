...
export function ExportCenter({ customerId, onExport }: ExportCenterProps) {
  ...
  const exportFormats: ExportFormat[] = [
    {
      ...
      description: 'Complete proposal ready for C-level presentations',
    ...
    },
    {
      ...
      description: 'ROI calculator with detailed cost breakdown',
      icon: TableCellsIcon,
      format: 'Excel',
      size: '~850 KB',
      available: true,
    },
    {
      ...
      description: 'Stakeholder-ready slides with compelling data',
    ...
    },
    {
      ...
      description: 'Send data directly to Salesforce or HubSpot',
  ...
  const getStatusIcon = () => {
    switch (exportStatus) {
      case 'loading':
        return <ClockIcon className="h-5 w-5 text-purple-400 animate-spin" />;
      case 'success':
  ...
  const getStatusMessage = () => {
    switch (exportStatus) {
      ...
      default:
        return 'Access your professional sales materials';
    }
  };
    ...
    <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          {getStatusIcon()}
          <h2 className="text-xl font-semibold text-white ml-3">Sales Materials Library</h2>
        </div>
        <button
      ...
      <div className="mb-6 p-4 bg-purple-900/20 border border-gray-800 rounded-lg">
        <p className="text-sm text-purple-300">
          <span className="font-medium">Professional materials ready:</span> All generated content is executive-ready for immediate use in sales conversations.
        </p>
      </div>
      ...
      <AnimatePresence>
        {showOptions && (
          <motion.div
            ...
            className="border border-gray-800 rounded-lg p-4 mb-6 bg-gray-800"
          >
            <h3 className="font-medium text-white mb-3">Export Settings</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500"
                >
            ...
            <div className="mt-4 space-y-2">
              <label className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-purple-400 focus:ring-purple-500 border-gray-600 bg-gray-700 rounded"
                />
                <span className="ml-2 text-sm text-gray-300">Include charts and visualizations</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-purple-400 focus:ring-purple-500 border-gray-600 bg-gray-700 rounded"
                />
                <span className="ml-2 text-sm text-gray-300">Include detailed analysis</span>
              </label>
              ...
              <label className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-purple-400 focus:ring-purple-500 border-gray-600 bg-gray-700 rounded"
                />
                <span className="ml-2 text-sm text-gray-300">Include recommendations</span>
              </label>
            </div>
          </motion.div>
        )}
        ...
        {exportFormats.map((format, index) => {
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex items-start space-x-3">
                  <div className={`p-2 rounded-lg ${
                    isSelected ? 'bg-purple-900/40' : 'bg-gray-800'
                  }`}>
              ...
              {!format.available && (
                <div className="mt-3 text-xs text-gray-500 bg-gray-800 px-2 py-1 rounded">
                  Coming soon
                </div>
              )}
            </motion.div>
      ...
      <div className="mt-6 pt-6 border-t border-gray-800">
        <h3 className="text-sm font-medium text-white mb-3">Recent Materials</h3>
        <div className="space-y-2 text-sm">
          <div className="flex items-center justify-between py-2 px-3 bg-gray-800 rounded">
            <div className="flex items-center">
              <DocumentTextIcon className="h-4 w-4 text-gray-400 mr-2" />
              <span className="text-gray-300">Executive Business Case - PDF</span>
            </div>
          ...
          <div className="flex items-center justify-between py-2 px-3 bg-gray-800 rounded">
            <div className="flex items-center">
              ...
              <span className="text-gray-300">Financial Analysis - Excel</span>
            </div>
