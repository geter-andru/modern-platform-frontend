...
const MOCK_RESOURCES: Resource[] = [
  ...
  {
    id: '3',
    title: 'Empathy Maps Guide',
    description: 'Step-by-step guide to creating customer empathy maps',
    tier: 1,
    category: 'guides',
    status: 'available',
  ...
  // Advanced Tier Resources
  {
    ...
    accessCount: 0,
    dependencies: ['product-details', 'icp-analysis', 'buyer-personas', 'empathy-maps'],
    exportFormats: ['PDF', 'DOCX', 'JSON']
  },
  // Strategic Tier Resources
  {
    ...
    accessCount: 0,
    dependencies: ['product-details', 'icp-analysis', 'buyer-personas', 'empathy-maps', 'sales-methodologies'],
    exportFormats: ['PDF', 'DOCX', 'JSON', 'CSV']
  }
];
